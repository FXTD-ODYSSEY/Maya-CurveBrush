...
class placeCtx(baseDraggerCtx):
    ...
    def __init__(self, ctxName):
        ...
        try:
            self.inMeshes.remove(self.sourceMesh)
        except:
            pass
    ...
    def moveCopy(self, dupType=""):
        try:
            meshHitInfo = ysvView.closestHitToMeshesInfo(
                self.inMeshes, self.cursorWPos, self.cursorWDir
            )
        except:
            return
    ...
    def selectPoly(self):
        ...
        closestMesh = ysvView.closestMeshFromHit(
